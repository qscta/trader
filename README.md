...
[![tests count](https://img.shields.io/badge/tests-496%20stdlib%20%2B%20104%20deps-brightgreen.svg)](trading/tests)
...
- **600 个测试**——496 个纯标准库用例（零依赖即可跑，含并发混沌 / 灾难恢复 / 变异测试）+ 104 个依赖版集成用例。
