...
[![tests count](https://img.shields.io/badge/tests-169%20stdlib%20%2B%2074%20deps-brightgreen.svg)](trading/tests)
...
- **243 个测试**——169 个纯标准库用例（零依赖即可跑，含并发混沌 / 灾难恢复 / 变异测试）+ 74 个依赖版集成用例。
...
# 169 用例，纯标准库，无需安装任何依赖（含并发混沌 / 灾难恢复 / 变异测试）
