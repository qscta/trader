...
[![tests count](https://img.shields.io/badge/tests-440%20stdlib%20%2B%20112%20deps-brightgreen.svg)](trading/tests)
...
- **552 个测试**——440 个纯标准库用例（零依赖即可跑，含并发混沌 / 灾难恢复 / 变异测试）+ 112 个依赖版集成用例。
...
# 440 用例，纯标准库，无需安装任何依赖（含并发混沌 / 灾难恢复 / 变异测试）
