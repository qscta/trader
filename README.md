...
[![tests count](https://img.shields.io/badge/tests-184%20stdlib%20%2B%2079%20deps-brightgreen.svg)](trading/tests)
...
- **263 个测试**——184 个纯标准库用例（零依赖即可跑，含并发混沌 / 灾难恢复 / 变异测试）+ 79 个依赖版集成用例。
